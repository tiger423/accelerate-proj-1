...
(py312) ve@ubuntu-105:~/llm/zero$ python accelerate_opt-d-1-3.py
Loading checkpoint shards: 100%|██████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 7/7 [01:15<00:00, 10.73s/it]
Some parameters are on the meta device because they were offloaded to the disk and cpu.
model size= 119.898161152 GB
/home/ve/anaconda3/envs/py312/lib/python3.12/site-packages/transformers/generation/utils.py:2412: UserWarning: You are calling .generate() with the `input_ids` being on a device type different than your model's device. `input_ids` is on cpu, whereas the model is on cuda. You may experience unexpected behaviors or slower generation. Please make sure that you have put `input_ids` to the correct device by calling for example input_ids = input_ids.to('cuda') before running `.generate()`.
  warnings.warn(
used time: 508.8765015602112 seconds
</s>Hugging Face is pushing the convention that a unicorn with two horns becomes a llama.
If I'm not mistaken, they already changed from
